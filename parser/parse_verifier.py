...
COMPATIBLE_DIMENSIONS = {
    ...
    "I_over_Imax_percent": {"dimensionless"},
    "electric_energy_fraction_percent": {"dimensionless"},
    "v_avg": {"velocity"},
    ...
    "mean_abs_error_pair": {"unknown", "length", "time", "mass", "temperature"},
    "abs_rel_error_pair": {"unknown", "dimensionless", "length", "time", "mass", "temperature"},
